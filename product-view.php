                ...
                <div class="container product_data mt-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h5> Selling Price: <span class="text-success fw-bold"><?= $product['selling_price']; ?></span></h5>
                                </div>
                                <div class="col-md-6">
                                    <h5>Normal Price: <s class="text-danger fw-bold"><?= $product['original_price']; ?></s></h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-5">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    <butto class="btn btn-danger px-4"><i class="fa fa-heart me-2"></i> Add to Wishist</button>
                                </div>
                            </div>
